export default function ProjectsSection() {
  const projects = [
    ...
    },
    {
      ...
      service: "Transporte de material e locação de equipamentos e Obra de edificação",
    },
    {
    ...
    },
    {
      ...
      client: "Consórcio BRT Goiânia",
      service: "Obra de arte corrente e concretagem",
    },
    {
      title: "Aeroporto de Macaé - RJ",
      client: "Conserva",
      service: "Execução de pavimentação e locação de equipamentos",
    },
    {
