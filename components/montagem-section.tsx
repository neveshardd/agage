            ...
            <div className="grid grid-cols-6 gap-3">
              <div className="col-span-6 rounded-xl overflow-hidden relative h-[350px]">
                <Image
                  ...
                  unoptimized
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#1A3767]/60 via-transparent to-transparent"></div>
              ...
              <div className="col-span-3 rounded-xl overflow-hidden h-32 relative">
                <Image
                  src={images[1].src}
                  alt={images[1].alt}
                  fill
