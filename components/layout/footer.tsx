...
export default function FooterSection() {
  ...
  return (
    <section id="contato" className="w-full border-t border-gray-100">
            ...
            <div className="max-w-6xl w-full px-6 lg:px-10 py-16 flex flex-col justify-center">
              ...
              <div className="space-y-6 max-w-md">
                ...
                <div>
                  ...
                  <div className="w-12 h-px bg-[#1B3E9F]/30 my-3" />
                  <p className="text-[#1B3E9F] text-base md:text-lg">
                    Polo Industrial Sol Nascente, Quadra B, Lote 13 e 26 - Águas Lindas de Goiás/GO
                  </p>
                </div>
              </div>
            </div>
